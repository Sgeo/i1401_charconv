...
// racingmars's tables
// https://github.com/racingmars/go3270/blob/master/ebcdic.go
// Derived from https://raw.githubusercontent.com/unicode-org/icu-data/refs/heads/main/charset/data/ucm/glibc-IBM1047-2.1.2.ucm
...
trie = '40F1F2F3F4F5F6F7F8F9F07B7C7D7E7F' +
       'F061E2E3E4E5E6E7E8E9E06B6C6D6E6F' +
       '60D1D2D3D4D5D6D7D8D9D05B5C5D5E5F' + 
       '50C1C2C3C4C5C6C7C8C9C04B4C4D4E4F' +
       '40F1F2F3F4F5F6F7F8F9F07B7C7D7E7F' +
       'F061E2E3E4E5E6E7E8E9E06B6C6D6E6F' +
       '60D1D2D3D4D5D6D7D8D9D05B5C5D5E5F' + 
       '50C1C2C3C4C5C6C7C8C9C04B4C4D4E4F' ;
sim1401_1047_encode = [];
for(let i = 0; i < 64; i++) {
    let hex = `${trie[2*i]}${trie[2*i+1]}`;
    let ebcdic = parseInt(hex, 16);
    let unicode_codepoint = cp1047toUnicode[ebcdic];
